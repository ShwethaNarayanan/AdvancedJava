...
<form method="post" action="/mysite/servlet/updateemailaddress">
	<table  cellpadding="0" cellspacing="0" width="50%"">
		...
		<%
			...
			session.setAttribute("emailid", eMailAddressVOO.geteMailID());
 		%>
		<tr>
			<td bgcolor="#FAFAF9" style="padding-left: 10px;">Email</td>
			<td><input type="text" disabled name="emailid" value="<%=eMailAddressVOO.geteMailID() %>" /></td>
		</tr>
		<tr>
