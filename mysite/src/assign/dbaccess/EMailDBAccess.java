...
// EMailAddress Queries
	...
	public static void updateEMailAddress(EMailAddressVOO inEMailAddress) throws Exception {
		...
		try {
			...
			pStmt = dbConn.prepareStatement(
					"UPDATE emailaddress SET emailaddress = ?, firstname = ? middlename = ? lastname = ?, homephoneno = ?, workphoneno = ?, mobileno = ?, groupid = ?");
			pStmt.setString(1, inEMailAddress.geteMailID());
			pStmt.setString(2, inEMailAddress.getfName());
			pStmt.setString(3, inEMailAddress.getmName());
			pStmt.setString(4, inEMailAddress.getlName());
	...
	/* *************************************************************** */
	public static void updatePhoneEMailAddress(EMailAddressVOO inEMailAddress) throws Exception {
		Connection dbConn = null;
		PreparedStatement pStmt = null;
		int rowsUpdated = 0;
		...
		try {
			dbConn = getConnection();
			pStmt = dbConn
					.prepareStatement("UPDATE emailaddress SET workphoneno = ?, mobileno = ? WHERE emailaddress = ?");
